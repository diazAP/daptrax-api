...
def upgrade() -> None:
    ...
    op.create_index("idx_transactions_user_type_date", "transactions", ["user_id", "transaction_type", "transaction_date"], unique=False)
    ...
    op.create_unique_constraint("uq_user_google_accounts_user_id", "user_google_accounts", ["user_id"])
    op.create_unique_constraint("uq_user_google_accounts_google_sub", "user_google_accounts", ["google_sub"])
